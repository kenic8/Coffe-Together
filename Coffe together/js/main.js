...
/// beacons laver et tomt array of fetcher json data og fylder i arrayet, med fetch.
/// det gemmes i en funktion kaldet beacon som kaldet ved klik, på markeren med de tildelte id
let beaconsarray = [];
...
function beacon() {
  fetch("json/beacons.json")
    ...
    .then(function(json) {
      beaconsarray = json;
      appendBeacons(beaconsarray);
      console.log(beaconsarray);
    });
}

////render vores informationer fra json --> i arrayet og til dommen. ///create new beacon

function appendBeacons(beaconsarray) {
  for (let beacon of beaconsarray) {
